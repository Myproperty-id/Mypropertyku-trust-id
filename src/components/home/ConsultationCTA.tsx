...
const benefits = [{
  icon: MessageCircle,
  text: "Konsultasi gratis dengan ahli properti"
}, {
  icon: Clock,
  text: "Jadwalkan sesuai waktu Anda"
}, {
  icon: CheckCircle,
  text: "Dapatkan panduan jual-beli properti"
}];
        ...
        once: true
          ...
          <div className="relative grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <Button size="lg" onClick={handleBooking} className="gap-2 bg-accent hover:bg-accent/90 text-accent-foreground font-semibold shadow-lg hover:shadow-xl transition-all">
